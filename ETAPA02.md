...
- Gestión de Hoteles: endpoints para crear, obtener, actualizar y eliminar hoteles.
- Gestión de Habitaciones: endpoints para crear, obtener, actualizar y eliminar habitaciones.
- Gestión de Tipos de Tarifas: endpoints para crear, obtener, actualizar y eliminar tarifas.
